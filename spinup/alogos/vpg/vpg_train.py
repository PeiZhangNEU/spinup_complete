...
import gym
import time
import spinup.alogos.vpg.core as core
from spinup.alogos.vpg.vpg import *
...
def train(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0,
        ...
        logger_kwargs=dict(), save_freq=10, use_gpu=True):
        '''
        ...
        agent = vpg(env_fn, actor_critic=actor_critic, ac_kwargs=ac_kwargs,
                    ...
                    vf_lr=vf_lr, train_v_iters=train_v_iters, lam=lam, logger_kwargs=logger_kwargs,device=device)
        env = env_fn()
